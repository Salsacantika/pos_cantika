...
@section('title', 'Riwayat Penjualan Bulanan')

@section('content')
<div class="container-fluid py-4 px-lg-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold" style="color: #6e4631;"><i class="bi bi-calendar-month me-2"></i>Riwayat Penjualan Bulanan</h2>
            <p class="text-muted small mb-0">Daftar transaksi berdasarkan bulan tertentu.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm p-4 mb-4 rounded-4">
        <form action="{{ route('penjualan.riwayat.bulanan') }}" method="GET" class="row g-3 align-items-center">
            <div class="col-md-4">
                <label class="form-label fw-semibold small">Pilih Bulan</label>
                <input type="month" name="bulan" value="{{ $bulan }}" class="form-control rounded-3">
            </div>
        ...
        <div class="table-responsive">
            <table class="table mb-0 align-middle">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="5" class="text-center py-4 text-muted">Tidak ada transaksi pada bulan ini.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
